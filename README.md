...
curl -X GET -F 'token=27c4eedf7148613e87264b78ae4c0a3bea1dda563ac2dab237df1e9d167f375c' localhost:8080/get-all-message-to-me
curl -X GET -F 'content=1_2024-04-30 22:23:09.txt' -F 'token=f6a70ddf1a543c89ed0dcc63fa8a09812dd4cac2e6a68aa547add92d58f2ea20' localhost:8080/get-message-content --output '1_2024-04-30 17:50:09.txt'
```
### POST
``` bash
