...
-F 'spk=d50ffb8450fc139576ff1efe893f23963e2be19d738080ac260d0bd148933881' \
...
-F 'token=d50ffb8450fc139576ff1efe893f23963e2be19d738080ac260d0bd148933886' \
localhost:8080/update-prekey-bundle

```
## x3dh phase 1
``` bash 
curl -X GET -F 'user=user1@mail.com' \
-F 'token=7fb26648cca726f2cce63eda8e92e220684d0200f08d7076a3a4beec121af720' \
localhost:8080/x3dh-phase1
```