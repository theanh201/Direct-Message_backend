...
-- UPDATE USER_TOKEN SET USER_TOKEN_TIMEOUT="20025-01-02 15:04:05" WHERE USER_ID=1;
-- UPDATE USER_TOKEN SET USER_TOKEN_IS_DEL=0 WHERE USER_ID=1;
select * from USER;
-- SELECT USER_TOKEN_TIMEOUT FROM USER_TOKEN WHERE USER_TOKEN = x'fe6440c86adff1a3789cb5803dd7d638c80aa9da09282b9071d683dd3ee22433';
-- SELECT USER_EMAIL, USER_PHONE_NUMB, USER_NAME, USER_AVATAR, USER_BACKGROUD FROM USER WHERE USER_NAME LIKE "" AND USER_IS_DEL = 0 AND USER_IS_PRIVATE = 0;
SELECT USER_EMAIL, USER_PHONE_NUMB, USER_NAME, USER_AVATAR, USER_BACKGROUND, USER_IS_PRIVATE FROM USER WHERE USER_ID=1 WHERE USER_IS_DEL=0;
CREATE TABLE USER (
    USER_ID INT AUTO_INCREMENT,
    USER_EMAIL CHAR(64) unique,
    USER_PHONE_NUMB CHAR(10) unique,
