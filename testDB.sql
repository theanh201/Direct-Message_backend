...
UPDATE MESSAGE SET MESSAGE_CONTENT='Deleted' WHERE USER_ID_FROM=1 AND MESSAGE_SINCE='2024-05-25';
SELECT USER_ID_FROM, USER_ID_TO, MESSAGE_CONTENT, MESSAGE_SINCE, MESSAGE_IS_ENCRYPT, MESSAGE_IS_FILE FROM MESSAGE WHERE (USER_ID_TO=1 AND USER_ID_FROM=2) OR (USER_ID_TO=2 AND USER_ID_FROM=1);
select * from MESSAGE;
